...
The following test results are recorded in the notebooks. Macro F1 is the primary comparison metric because the test set is strongly imbalanced toward positive reviews.

| Model | Training distribution | Accuracy | Macro F1 | Weighted F1 |
| --- | --- | ---: | ---: | ---: |
| LinearSVC | Imbalanced | 0.9192 | 0.7542 | 0.9131 |
| Bidirectional LSTM | Balanced | 0.9000 | 0.7600 | - |
| MLP | Balanced | 0.8674 | 0.7326 | 0.8822 |
| MLP | Imbalanced | 0.9196 | 0.7605 | 0.9150 |
| DistilBERT | Imbalanced | **0.9448** | **0.8368** | - |
